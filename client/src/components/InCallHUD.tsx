    ...
    <AnimatePresence>
      {isInCall && (
        <motion.div
          ...
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          className="absolute inset-x-6 bottom-[100px] backdrop-blur-xl bg-black/60 border border-border rounded-2xl z-20 flex flex-col items-center justify-center p-6 text-center"
          style={{ top: 'auto', height: 'auto', minHeight: '280px' }}
        >
          <div className="h-4 w-4 rounded-full bg-foreground animate-pulse mb-4 shadow-lg" />
          ...
          {/* Audio Visualizer */}
          <div className="w-full h-16 bg-muted rounded-xl border border-border mb-6 flex justify-center items-center overflow-hidden">
