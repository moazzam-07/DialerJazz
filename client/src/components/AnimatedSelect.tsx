    ...
    <div ref={containerRef} className={`relative w-full ${className}`}>
      <motion.button
        ...
        className={`
          ...
          ${disabled ? 'opacity-50 cursor-not-allowed' : 'hover:border-foreground/30 cursor-pointer'}
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute z-50 w-full mt-2 rounded-xl bg-background border border-input shadow-sm overflow-hidden"
          >
                ...
                <motion.button
                  ...
                  transition={{ delay: index * 0.015, duration: 0.15 }}
                    className={`
                      ...
                      ${selectedValue === option.value ? 'bg-primary/5 text-primary font-medium' : 'text-foreground'}
                    `}
